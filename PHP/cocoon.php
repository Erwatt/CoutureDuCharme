...
<html>
    ...
    <head>
        ...
        var nom = new objet ("cocoon.jpg", "cocoon2.jpg", "cocoon3.jpg");
        function suivante() {
        numero += 1;
        ...
        <div class="box1">
            <div class="element1">
                <div class="box2">
                    ...
                    <div class="element2">
                        <p>
                            <div align="center">&nbsp;<img src="IMAGE/cocoon.jpg" width="450" height="300" name="image"></div>
                            <form name="vision">
                            <div align="center">
                    ...
                    <div class="element2 border">
                        <div class="box3">
                            ...
                            <div class="element3">
                                ...
                                <p class="text">
                                    Lit: 1 lit double, 2 lits simples
                                </p>
                            </div>
                    ...
                    <div class="element2 border">
                        <div class="box3">
                            ...
                            <div class="element3">
                                <p class="text">
                                La chambre familiale accueille les familles jusqu'à quatre enfants.
                                Profitez d'une pièce spacieuse et passez des moments inoubliables
                                avec votre famille. Elle comprend une télévision à écran plat,
                                un micro-ondes et un coin repas.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="element1 calendar">
                <div data-key="amkkhds7" data-numgite="2697" data-widget-itea="dispo" data-numchambre="3" data-nbmois="1" data-nbmois-ligne="1"></div>
            </div>
        </div>
    </body>
